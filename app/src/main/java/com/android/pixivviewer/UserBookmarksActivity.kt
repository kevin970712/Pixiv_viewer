...
import com.android.pixivviewer.ui.UserBookmarksScreen
import com.android.pixivviewer.ui.theme.PixivViewerTheme

class UserBookmarksActivity : ComponentActivity() {
    ...
    companion object {
        ...
        fun newIntent(context: Context, userId: Long): Intent {
            return Intent(context, UserBookmarksActivity::class.java).apply {
